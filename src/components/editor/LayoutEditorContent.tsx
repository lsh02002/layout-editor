...
function LayoutEditorContent() {
  ...
  const {
    ...
    setNewProps,
    changeNewType,
  } = useCreateComponentForm(componentRegistry);
  ...
  const filteredLayerComponents = useMemo(
    () => filterLayerComponents(componentRegistry, components, layerSearch),
    [componentRegistry, components, layerSearch],
  );
  ...
  const downloadHtml = useCallback(
    () => downloadHtmlFile(componentRegistry, components, projectCustomCss),
    [componentRegistry, components, projectCustomCss],
  );
...
export default LayoutEditorContent;
